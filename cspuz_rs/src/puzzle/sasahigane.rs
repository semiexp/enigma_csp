...
mod tests {
    ...
    fn test_sashigane_problem() {
        ...
        let expected = graph::BoolInnerGridEdgesIrrefutableFacts {
            horizontal: vec![
                vec![Some(true), Some(true), Some(false), Some(false), Some(true), Some(true)],
                vec![Some(true), Some(false), Some(true), Some(false), Some(false), Some(true)],
                vec![Some(false), Some(true), Some(false), Some(true), Some(false), Some(false)],
                vec![Some(true), Some(true), Some(false), Some(false), Some(true), Some(false)],
                vec![Some(true), Some(true), Some(true), Some(true), Some(true), Some(false)],
            ],
            vertical: vec![
